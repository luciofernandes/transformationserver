                ...
                <div class="box-body">
                  <table id="list" class="table table-bordered table-striped">
                    ...
                    <c:forEach items="${revisions}" var="revision">
	                    <tr>
		                    <td>${revision[1].user}</td>
		                    <td><fmt:formatDate type="both" value="${revision[1].revisionDate}" /> </td>
		                    <td>${revision[2]}</td>
		                    <td>${revision[0].name}</td>
		                    <td>${revision[0].email}</td>
		                    <td>${revision[0].password}</td>
	                    </tr>
                     </c:forEach> 
                    </tbody>
                  </table>
  				...
  				<div class="row box-footer">
            		<div class="col-xs-12">
            			<spring:url var="backButtonURL" value="/user/form/${id}" />  
				         <a href="${backButtonURL}" title="Back" class="btn btn-default pull-left" > Back</a>
            		</div>
        		</div>
